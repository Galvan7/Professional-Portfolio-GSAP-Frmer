    ...
    <header className="absolute w-full z-50 transition-all duration-300">
      ...
      {contactFormOpen && (
        ...
        className="fixed inset-0 bg-black/50 background-blur-sm z-50 flex items-center justify-center p-4">
          ...
          className="bg-white dark:bg-gray-800 roundex-xl shadow-xl w-full max-w-md p-6">
              ...
              <form className="space-y-4">
                ...
                <div>
                  ...
                  <input type="email" id="name" placeholder="Your Email" className="w-full px-4 py-2 border border-gray-600 rounded-lg focus:ring-2 focus:ring-violet-500 focus:border-violet-500 bg-gray-700" />
                </div>
                <div>
                  <label htmlFor="message" className="block text-sm font-medium text-gray-300 mb-1">Message</label>
                  <textarea rows={4} id="message" placeholder="How can I be of service" className="w-full px-4 py-2 border border-gray-600 rounded-lg focus:ring-2 focus:ring-violet-500 focus:border-violet-500 bg-gray-700" />
                </div>
                <motion.button 
                type="submit"
                whileHover={{scale:1.03}}
                whileTap={{scale:0.97}}
                className="w-full px-4 py-2 bg-gradient-to-r from-violet-600 to-violet-400 hover:from-violet-700 to-purple-700 transition-all duration-300 rounded-lg shadow-md hover:shadow-violet-600/50">
                  Send Message
                </motion.button>
              </form>
