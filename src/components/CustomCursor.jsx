...
const CustomCursor = () => {
  ...
  return (
    <>
        ...
        <div ref={cursorBorderRef} className="fixed top-0 left-0 w-[40px] h-[40px] border rounded-full pointer-events-none z-[999] mix-blend-difference opacity-50"/>
